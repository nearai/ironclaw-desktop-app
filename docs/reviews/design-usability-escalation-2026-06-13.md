...
- Static bundle-size gate: `npm run check:static-bundle`
  ...
  - Current gzipped tracked assets: cold start 343.7 KB / 400 KB; `main.bundle.js` 308.7 KB / 350 KB; boot vendor 22.3 KB / 35 KB; lazy code highlighting 52.0 KB / 60 KB; document/PDF lazy assets 516.3 KB / 600 KB; OCR lazy assets 2501.5 KB / 2800 KB; all tracked assets 3413.5 KB / 3900 KB.
...
- Static accessibility gate: `npm run test:a11y-static`
  - Status: passed.
  - Full static Playwright project now runs 25 rendered tests: 15 axe surfaces, 3 attachment ingress proofs, 1 connector lifecycle proof, and 6 keyboard/approval flows.
