  ...
  return html`
    <div data-testid="logs-entry" className=${rowBg}>
      <div
        ...
        className=${[
          'grid cursor-pointer select-none gap-x-3 border-b border-[color-mix(in_srgb,var(--v2-panel-border)_58%,transparent)] px-4 py-1.5 font-mono text-xs hover:bg-[var(--v2-surface-muted)]',
