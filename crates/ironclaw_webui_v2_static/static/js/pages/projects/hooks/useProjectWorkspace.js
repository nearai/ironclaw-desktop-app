...
export function useProjectWorkspace(projectId) {
  ...
  return {
    ...
    isLoading:
      enabled && (projectQuery.isLoading || missionsQuery.isLoading || threadsQuery.isLoading),
    isRefreshing:
    ...
    error:
      projectQuery.error || missionsQuery.error || threadsQuery.error || widgetsQuery.error || null,
    invalidate
  };
}
