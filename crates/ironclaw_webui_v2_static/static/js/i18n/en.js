...
registerPack('en', {
  ...
  'traceCommons.note':
    'Credits are calculated server-side. Local values may change after scoring or privacy review.',
  ...
  'automations.filter.failures': 'Needs review',
  'automations.filter.paused': 'Paused',
  'automations.refresh': 'Refresh automations',
  'automations.refreshing': 'Refreshing automations',
  'automations.error.loadFailed': 'Unable to load automations',
  'automations.schedulerOff.title': 'Scheduler is off',
  'automations.schedulerOff.description':
    'Saved schedules are visible, but this gateway is not currently firing recurring runs.',
  ...
  'automations.summary.runningDetail': 'Schedules with a run currently in progress.',
  'automations.summary.failures': 'Needs review',
  'automations.summary.failuresDetail': 'Schedules with a failed recent run.',
  ...
  'automations.empty.onboardingDescription':
    "Automations are created by chatting with your agent. Ask it to do something on a schedule and it'll set up a recurring automation for you.",
  ...
  'automations.empty.example2': 'Every weekday at 9am, send me a summary of my unread email.',
  'automations.empty.example3': 'Remind me to review open pull requests every afternoon at 3pm.',
  ...
  'automations.runs.showingOf': 'Showing {shown} of {total} runs',
  'automations.detail.emptyTitle': 'Select an automation',
  'automations.detail.emptyDescription': 'Pick a scheduled automation to inspect its recent runs.',
  ...
  'automations.detail.noRuns': 'No recent runs yet.',
  'automations.detail.thread': 'Thread',
  'automations.detail.noThread': 'No thread yet',
  'automations.detail.run': 'Run',
  'automations.detail.openRun': 'Open chat',
  ...
  'logs.unsupported': "This gateway doesn't expose activity logs yet.",
  'logs.empty':
