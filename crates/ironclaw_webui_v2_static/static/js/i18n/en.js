...
registerPack('en', {
  ...
  'login.tagline': 'Local agent',
  'login.hero': 'Local agent control without losing runtime context.',
  'login.heroSub':
    'Token access ties this session to the same gateway runtime, approvals, tools, and thread state.',
  'login.bearerAuth': 'Bearer auth',
  'login.bearerDesc': 'Paste the local gateway token to connect.',
  'login.console': 'IronClaw session',
  ...
  'chat.deleteThreadConfirm': 'Delete this conversation? This can’t be undone.',
  'chat.loadFailed': 'Couldn’t load conversations.',
  'chat.loadOlder': 'Load older',
  'chat.loadingConversations': 'Loading conversations…',
  'chat.searchingOlder': 'Searching older conversations…',
  'command.noMatches': 'No matches',
  'command.noMatchesHint': 'Try a different search.',
  'common.retry': 'Retry',
  'extensions.browseKnowledgeApps': 'Browse knowledge apps',
  'extensions.gatewayUnavailable':
    'The local gateway is unavailable, so app setup can’t start yet.',
  'job.filterEventsLabel': 'Filter events',
  'onboarding.gatewayCheckingDesktop': 'Checking the local gateway…',
  'onboarding.gatewayCheckingWeb': 'Checking the gateway…',
  'onboarding.gatewayFollowupCopyDesktop': 'We’ll connect once the local gateway is ready.',
  'onboarding.gatewayFollowupCopyWeb': 'We’ll connect once the gateway is ready.',
  'onboarding.gatewayPendingCopyDesktop': 'Starting the local gateway…',
  'onboarding.gatewayPendingCopyWeb': 'Connecting to the gateway…',
  'onboarding.gatewayReady': 'Gateway ready',
  ...
  'onboarding.gatewayUnavailableCopyWeb': 'The gateway isn’t reachable yet.',
  'onboarding.gatewayUnavailableDesktop': 'Local gateway unavailable',
  'onboarding.gatewayUnavailableWeb': 'Gateway unavailable',
  'onboarding.staticPreviewUnavailable': 'Static preview needs a gateway',
  ...
  'chat.emptyTitle': 'Start with a concrete task.',
  'chat.emptyDesc':
  ...
  'chat.heroPlaceholder': 'What can I help with?',
  ...
  'traceCommons.heldDescription':
    'Held because of higher privacy risk; review and authorize to submit.',
  ...
  'settings.restartUnavailable':
    "Restart from the web UI isn't available yet. Restart the gateway process manually to apply pending changes.",
  ...
  'onboarding.subtitle':
    'Choose an AI provider to get started. You can change or add more later in Settings.',
  ...
  'onboarding.providerNearai': 'NEAR AI Cloud',
  'onboarding.providerNearaiDesc': 'Free hosted models. Use an API key or SSO.',
  'onboarding.providerCodex': 'OpenAI chat plan',
  'onboarding.providerCodexDesc': 'Use your existing OpenAI Plus or Pro plan.',
  ...
  'onboarding.nearaiLocalSso':
    "NEAR AI browser sign-in (GitHub, Google, NEAR Wallet) isn't supported on localhost — NEAR AI rejects local callback URLs. Add a NEAR AI API key instead, or run behind a public URL.",
  'onboarding.codexSignIn': 'Sign in with OpenAI',
  'onboarding.codexEnterCode': 'Enter this code in the opened tab to authorize:',
  'onboarding.codexWaiting': 'Waiting for OpenAI authorization in the opened tab…',
  'onboarding.codexTimeout': 'OpenAI sign-in timed out. Please try again.',
  'onboarding.codexFailed': 'OpenAI sign-in failed. Please try again.',
  ...
  'jobs.list.empty.noJobsDesc':
    'Background work, sandbox runs, and agent-initiated tasks will appear here once the gateway starts creating jobs.',
  ...
  'automations.summary.failuresDetail': 'Automations with a failed run in recent history.',
  ...
  'routines.description':
    'Search saved routines, inspect their schedule or trigger, and run or pause them.',
  ...
  'chat.deleteBusy':
    "Can't delete a conversation while it's still running. Stop it first, then try again.",
  ...
  'extensions.emptyInstalledDesc':
    'Browse the Registry tab to discover and install WASM tools, channels, and MCP servers.',
  'extensions.emptyMcpTitle': 'No knowledge apps connected',
  'extensions.emptyMcpDesc':
    'Knowledge apps give IronClaw access to your tools and data. Browse knowledge apps to connect one.',
  ...
  'chat.modelPopoverProvider': 'Provider',
  ...
  'onboarding.promiseFilesTitle': 'Generated work stays in your dossier',
  'onboarding.promiseFilesBody':
    'Documents IronClaw generates are saved to Work, where you can reopen and export them.',
