...
registerPack('en', {
  ...
  'chat.heroMorning': 'Good morning. What should we get done?',
  'chat.heroAfternoon': 'Good afternoon. What should we get done?',
  'chat.heroEvening': 'Good evening. What should we get done?',
  'chat.heroDesc': 'Ask anything, or drop in documents that need work.',
  ...
  'chat.attachmentExtracting': 'extracting…',
  'chat.attachmentExtracted': 'text extracted ({chars} chars)',
  'chat.attachmentNoText': 'no readable text — not sent',
  'chat.attachmentMetadataOnly': 'sent as file only — content not readable',
  ...
  'googleOauth.desc':
    'Add a Google OAuth client ID to connect Gmail and Calendar with your browser — no token pasting. Create a "Desktop app" client, enable the Gmail scopes on its consent screen, and paste the client ID here.',
  ...
  'googleOauth.hint': 'One-time setup, about five minutes.',
  ...
  'onboarding.subtitle':
    'Connect NEAR AI Cloud to get started. IronClaw handles model access through our infra.',
  'onboarding.setUp': 'Set up',
  'onboarding.signIn': 'Sign in',
  'onboarding.nearWallet': 'NEAR Wallet',
  'onboarding.ready': 'Ready',
  'onboarding.moreInSettings': 'Model access and fallback API-key setup live in',
  ...
  'onboarding.providerOpenai': 'Advanced provider',
  'onboarding.providerOpenaiDesc': 'Hidden in Desktop until advanced provider mode ships.',
  'onboarding.providerAnthropic': 'Advanced provider',
  'onboarding.providerAnthropicDesc': 'Hidden in Desktop until advanced provider mode ships.',
  'onboarding.providerOllama': 'Advanced local provider',
  'onboarding.providerOllamaDesc': 'Hidden in Desktop until advanced provider mode ships.',
  ...
  'onboarding.providerNearaiDescDesktop':
    'Sign in once; IronClaw routes models through NEAR AI Cloud. API key setup is a fallback.',
