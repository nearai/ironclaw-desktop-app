...
registerPack('en', {
  ...
  'chat.modelPopoverNoProvider': 'No provider active',
  'chat.modelPopoverEmpty': 'This provider does not expose a model list.',
  'chat.modelPopoverError': 'Could not load models — check the provider connection.',
  'chat.modelPopoverManualPlaceholder': 'Enter a model id',
  'chat.modelPopoverManage': 'Manage providers in Settings',
  ...
  'onboarding.providerNearaiDescDesktop':
    'Free hosted models. Paste an API key from private.near.ai, or connect your NEAR wallet.',
