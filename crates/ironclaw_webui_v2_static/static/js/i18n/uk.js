...
registerPack('uk', {
  ...
  'login.heroSub':
    'Доступ за токеном прив’язує консоль браузера до того ж runtime шлюзу, затверджень, інструментів і стану тредів.',
  ...
  'chat.emptyDesc':
    'Надішліть повідомлення, прикріпіть файли або попросіть перевірити шлюз. Робочий простір показує затвердження й runtime-активність у процесі виконання.',
  ...
  'authGate.resolveFailedAfterTokenSaved':
    'Токен збережено. Не вдалося відновити заблокований запуск; повторіть спробу відновити його.',
  ...
  'traceCommons.description':
    'Кредит, зароблений за надані відредаговані трейси, у межах вашого облікового запису.',
  'traceCommons.emptyState':
    'Не зареєстровано — попросіть свого агента пройти реєстрацію за запрошенням Trace Commons.',
  ...
  'traceCommons.heldDescription':
    'Затримано через вищий ризик конфіденційності; перегляньте та авторизуйте надсилання.',
  ...
  'traceCommons.note':
    'Локальний перегляд станом на останню синхронізацію — офіційний реєстр кредитів знаходиться на сервері. Остаточний кредит може змінитися після перевірки конфіденційності, повторного відтворення/оцінювання, перевірок дублікатів і подальшого оцінювання корисності.',
  'settings.back': 'Назад',
  ...
  'settings.restartUnavailable':
    'Перезапуск через вебінтерфейс ще недоступний. Перезапустіть процес шлюзу вручну, щоб застосувати незавершені зміни.',
  ...
  'onboarding.subtitle':
    'Щоб почати, виберіть постачальника штучного інтелекту. Ви можете змінити або додати більше пізніше в налаштуваннях.',
  ...
  'onboarding.nearaiLocalSso':
    'Вхід у NEAR AI через браузер (GitHub, Google, гаманець NEAR) не підтримується на localhost — NEAR AI відхиляє локальні URL зворотного виклику. Додайте натомість ключ API NEAR AI або запустіть за публічним URL.',
  ...
  'channels.slackAccessInstructions':
    'Виберіть канали Slack, на які ця програма tenant може відповісти.',
  ...
  'skills.noInstalledDesc':
    'Скіли додають агенту доменні інструкції. Встановіть їх із реєстру ClawHub або покладіть файли SKILL.md у робочий простір.',
  'skills.failedLoad': 'Не вдалося завантажити скіли: {message}',
  'skills.import': 'Імпорт навичок',
  'skills.importDesc':
    'Встановлення з URL-адреси HTTPS SKILL.md або безпосередньо вставте вміст SKILL.md.',
  'skills.name': 'Назва навички',
  'skills.namePlaceholder': 'Назва навички',
  'skills.url': 'URL-адреса HTTPS',
  'skills.urlHint':
    'Використовуйте пряме посилання HTTPS на SKILL.md або підтримуваний пакет навичок.',
  'skills.urlPlaceholder': 'https://example.com/SKILL.md',
  'skills.content': 'Вміст SKILL.md',
  'skills.contentHint':
    'Використовуйте це замість URL-адреси, коли імпортуєте локальний або скопійований вміст навичок.',
  ...
  'users.adminRequiredDesc':
    'Керування користувачами доступне лише обліковим записам із правами адміністратора.',
  ...
  'jobs.list.queueDesc':
    'Пошук за назвою або ID, перехід до запуску та зупинка активної роботи без виходу зі сторінки.',
  ...
  'jobs.list.empty.noMatchDesc':
    'Спробуйте ширший запит або скиньте фільтр стану, щоб побачити решту черги.',
  'jobs.list.empty.noJobsTitle': 'Поки що немає завдань',
  'jobs.list.empty.noJobsDesc':
    'Фонова робота, запуски sandbox та втручання оператора з’являться тут, щойно gateway почне створювати завдання.',
  ...
  'automations.delivery.explainer':
    'Виберіть, куди доставляються результати автоматизації після завершення спрацьованого запуску.',
  ...
  'automations.delivery.webOptionDesc':
    'Результати зберігаються в історії запусків. Жодне приватне повідомлення чи сповіщення не надсилається.',
  'automations.delivery.unpairedNotice': 'Slack DM — недоступно',
  'automations.delivery.unpairedDesc':
    'Підключіть свій обліковий запис Slack, щоб увімкнути доставку через приватні повідомлення.',
  ...
  'automations.delivery.footnote':
    'На запити підтвердження, надіслані у ваш DM, відповідають, відповівши {command} у Slack.',
  ...
  'projects.creationDraft':
    'Створи для мене новий проєкт. Я хочу налаштувати автономний робочий простір для: ',
  'projects.chatAutoFail':
    'Не вдалося підготувати чат автоматично. Відкриваю чат у будь-якому разі.',
  ...
  'projects.noDescription':
    'Опису проєкту ще немає. Робочий простір усе ще формується активними місіями та історією гілок.',
  ...
  'projects.general.desc':
    'Спільний контекст, разова робота та універсальний шлях виконання для гілок, які ще не підвищені до іменованого проєкту.',
  'projects.scoped.title': 'Проєкти зі спеціалізацією',
  'projects.scoped.desc':
    'Переглядайте сталi робочі простори, інспектуйте місії, переглядайте нещодавню активність і переходьте до проєкту, який потрібен вам зараз.',
  'projects.scoped.onlyGeneralTitle': 'Активний лише загальний робочий простір',
  'projects.scoped.onlyGeneralDesc':
    'Створіть іменований проєкт, коли робота заслуговує власних місій, файлів, віджетів і довготривалого контексту.',
  'projects.empty.noMatchTitle': 'Немає проєктів, що відповідають пошуку',
  'projects.empty.noMatchDesc':
    'Спробуйте ширший запит або очистіть фільтр, щоб повернутися до повної карти робочого простору.',
  'projects.empty.noneTitle': 'Поки що немає проєктів',
  'projects.empty.noneDesc':
    'Проєкти з’являються, коли асистент створює довговічні робочі простори. Ви можете почати з чату й попросити IronClaw створити проєкт для тривалої роботи.',
  ...
  'extensions.emptyInstalledDesc':
    'Перегляньте вкладку Реєстр, щоб знайти та встановити інструменти, канали та сервери WASM.',
  'extensions.emptyMcpTitle': 'Немає серверів MCP',
  'extensions.emptyMcpDesc':
    'Сервери MCP розширюють агент за допомогою додаткових інструментальних можливостей за допомогою протоколу модельного контексту. Встановіть їх з реєстру.',
  ...
  'settings.notWritableDesc':
    'Цей шлюз поки не може зберігати зміни цих налаштувань, тому елементи керування приховано, а не показано як редаговані. Вони повернуться, щойно шлюз зможе їх зберігати.'
});
