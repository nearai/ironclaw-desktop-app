...
registerPack('hi', {
  ...
  'authGate.oauthWaiting':
    'प्राधिकरण पूरा होने की प्रतीक्षा कर रहा है... एक बार पहुंच स्वीकृत हो जाने के बाद आप पॉपअप टैब बंद कर सकते हैं।',
  ...
  'authGate.resolveFailedAfterTokenSaved':
    'टोकन सहेजा गया। अवरुद्ध रन को फिर से शुरू नहीं किया जा सका; इसे फिर से शुरू करने का पुनः प्रयास करें.',
  ...
  'traceCommons.description':
    'योगदान किए गए संपादित ट्रेस के लिए अर्जित क्रेडिट, आपके खाते तक सीमित।',
  'traceCommons.emptyState':
    'नामांकित नहीं — अपने एजेंट से Trace Commons आमंत्रण के साथ नामांकन करने को कहें।',
  ...
  'traceCommons.heldDescription':
    'अधिक गोपनीयता जोखिम के कारण रोका गया; सबमिट करने के लिए समीक्षा कर अधिकृत करें।',
  ...
  'traceCommons.note':
    'अंतिम सिंक के समय का स्थानीय दृश्य — आधिकारिक क्रेडिट बहीखाता सर्वर-साइड है। गोपनीयता समीक्षा, रीप्ले/मूल्यांकन, डुप्लिकेट जाँच और बाद की उपयोगिता स्कोरिंग के बाद अंतिम क्रेडिट बदल सकता है।',
  'settings.back': 'वापस',
  ...
  'settings.restartUnavailable':
    'वेब UI से पुनरारंभ अभी उपलब्ध नहीं है। लंबित परिवर्तनों को लागू करने के लिए गेटवे प्रक्रिया को मैन्युअल रूप से पुनरारंभ करें।',
  ...
  'onboarding.subtitle':
    'आरंभ करने के लिए एक AI प्रदाता चुनें। आप बाद में सेटिंग्स में बदलाव कर सकते हैं या और अधिक जोड़ सकते हैं।',
  ...
  'onboarding.providerNearaiDesc':
    'निःशुल्क होस्ट किए गए मॉडल में कॉन्फ़िगर करें। एपीआई कुंजी या एसएसओ का उपयोग करें।',
  ...
  'onboarding.providerOllamaDesc':
    'स्थानीय स्तर पर खुले मॉडल चलाएँ। किसी API कुंजी की आवश्यकता नहीं है.',
  ...
  'onboarding.nearaiLocalSso':
    'ब्राउज़र से NEAR AI साइन-इन (GitHub, Google, NEAR वॉलेट) localhost पर समर्थित नहीं है — NEAR AI लोकल कॉलबैक URL अस्वीकार करता है। इसके बजाय NEAR AI API key जोड़ें, या किसी सार्वजनिक URL के पीछे चलाएँ।',
  ...
  'skills.contentHint':
    'स्थानीय या कॉपी की गई कौशल सामग्री आयात करते समय URL के बजाय इसका उपयोग करें।',
  ...
  'workspace.searching': 'खोजा जा रहा है...',
  'workspace.noResults': 'कोई परिणाम नहीं।',
  ...
  'automations.delivery.explainer':
    'चुनें कि ट्रिगर किया गया रन समाप्त होने पर स्वचालन परिणाम कहाँ डिलीवर किए जाएँ।',
  ...
  'automations.delivery.webOptionDesc':
    'परिणाम रन इतिहास में संग्रहीत होते हैं। कोई DM या सूचना नहीं भेजी जाती।',
  ...
  'automations.delivery.footnote':
    'आपके DM पर भेजे गए अनुमोदन अनुरोधों का उत्तर Slack में {command} का उत्तर देकर दिया जाता है।',
  ...
  'admin.users.deleteUserDesc':
    'क्या आप वाकई "{name}" हटाना चाहते हैं? इस एक्शन को वापस नहीं किया जा सकता।',
  ...
  'extensions.emptyInstalledDesc':
    'WASM टूल, चैनल और MCP सर्वर को खोजने और इंस्टॉल करने के लिए रजिस्ट्री टैब ब्राउज़ करें।',
  'extensions.emptyMcpTitle': 'कोई MCP सर्वर नहीं',
  'extensions.emptyMcpDesc':
    'MCP सर्वर मॉडल कॉन्टेक्स्ट प्रोटोकॉल पर अतिरिक्त टूल क्षमताओं के साथ एजेंट का विस्तार करते हैं। उन्हें र��िस्ट्री से स्थापित करें.',
