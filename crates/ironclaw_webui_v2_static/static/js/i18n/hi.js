...
registerPack('hi', {
  ...
  'login.heroSub':
    'टोकन एक्सेस ब्राउज़र कंसोल को उसी गेटवे runtime, approvals, tools और thread state से जोड़ता है।',
  ...
  'chat.emptyDesc':
    'संदेश भेजें, फ़ाइलें जोड़ें, या गेटवे चेक माँगें। वर्कस्पेस टर्न के दौरान approvals और runtime activity दिखाता है।',
  ...
  'skills.noInstalledDesc':
    'Skills एजेंट को domain-specific instructions के साथ extend करती हैं। इन्हें ClawHub registry से install करें या workspace में SKILL.md फाइलें रखें।',
  ...
  'users.adminRequiredDesc':
    'User management केवल admin privileges वाले accounts के लिए उपलब्ध है।',
  ...
  'jobs.list.empty.noMatchDesc':
    'और व्यापक खोज शब्द आज़माएँ या कतार का बाकी हिस्सा देखने के लिए स्टेट फ़िल्टर रीसेट करें।',
  'jobs.list.empty.noJobsTitle': 'अभी कोई जॉब नहीं',
  'jobs.list.empty.noJobsDesc':
    'बैकग्राउंड काम, सैंडबॉक्स रन, और ऑपरेटर हस्तक्षेप यहाँ तब दिखेंगे जब gateway जॉब बनाना शुरू करेगा।',
  ...
  'ext.registry.emptyDesc':
    'सभी उपलब्ध एक्सटेंशन पहले से इंस्टॉल हैं, या कोई रजिस्ट्री कॉन्फ़िगर नहीं है।',
  ...
  'projects.creationDraft':
    'मेरे लिए एक नया प्रोजेक्ट बनाओ। मैं इसके लिए एक स्वायत्त वर्कस्पेस सेट करना चाहता/चाहती हूँ: ',
  ...
  'projects.noDescription':
    'अभी कोई प्रोजेक्ट विवरण नहीं। वर्कस्पेस अभी भी सक्रिय मिशन और थ्रेड इतिहास से आकार ले रहा है।',
  'projects.general.label': 'जनरल वर्कस्पेस',
  'projects.general.title': 'डिफ़ॉल्ट प्रोजेक्ट कंट्रोल रूम',
  'projects.general.desc':
    'साझा संदर्भ, तदर्थ काम, और उन थ्रेड्स के लिए कैच-ऑल रनटाइम पाथ जो अभी नामित प्रोजेक्ट में प्रमोट नहीं हुए हैं।',
  'projects.scoped.title': 'स्कोप्ड प्रोजेक्ट',
  'projects.scoped.desc':
    'ड्यूरेबल वर्कस्पेस ब्राउज़ करें, मिशन देखें, हालिया गतिविधि रिव्यू करें, और उस प्रोजेक्ट में जाएँ जिसे अभी आपकी ज़रूरत है।',
  'projects.scoped.onlyGeneralTitle': 'केवल जनरल वर्कस्पेस सक्रिय है',
  'projects.scoped.onlyGeneralDesc':
    'जब काम अपने मिशन, फ़ाइलें, विजेट्स, और लंबे समय का संदर्भ माँगे, तब एक नामित प्रोजेक्ट बनाएँ।',
  'projects.empty.noMatchTitle': 'खोज से मेल खाने वाला कोई प्रोजेक्ट नहीं',
  'projects.empty.noMatchDesc':
    'और व्यापक खोज आज़माएँ या फ़िल्टर हटाकर पूरे वर्कस्पेस मैप पर लौटें।',
  'projects.empty.noneTitle': 'अभी कोई प्रोजेक्ट नहीं',
  'projects.empty.noneDesc':
    'जब असिस्टेंट ड्यूरेबल वर्कस्पेस बनाता है तब प्रोजेक्ट दिखाई देते हैं। आप चैट से शुरू कर सकते हैं और IronClaw से जारी काम के लिए स्कोप्ड प्रोजेक्ट बनाने को कह सकते हैं।',
