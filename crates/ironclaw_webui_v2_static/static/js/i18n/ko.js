...
registerPack('ko', {
  ...
  'login.heroSub':
    '토큰 접근은 브라우저 콘솔을 동일한 게이트웨이 런타임, 승인, 도구 및 스레드 상태에 연결합니다.',
  ...
  'chat.emptyDesc':
    '메시지를 보내거나, 파일을 첨부하거나, 게이트웨이 점검을 요청하세요. 워크스페이스는 진행 중 승인 및 런타임 활동을 표시합니다.',
  ...
  'authGate.oauthWaiting':
    '승인이 완료되기를 기다리는 중… 액세스를 승인한 후 팝업 탭을 닫을 수 있습니다.',
  ...
  'authGate.resolveFailedAfterTokenSaved':
    '토큰이 저장되었습니다. 차단된 실행을 재개할 수 없습니다. 다시 시작해 보세요.',
  ...
  'traceCommons.description':
    '기여한 편집된 트레이스로 획득한 크레딧이며, 내 계정 범위로 표시됩니다.',
  ...
  'traceCommons.note':
    '마지막 동기화 기준 로컬 보기입니다 — 공식 크레딧 원장은 서버에 있습니다. 최종 크레딧은 개인정보 검토, 리플레이/평가, 중복 검사 및 후속 유용성 평가 후 변경될 수 있습니다.',
  'settings.back': '뒤로',
  ...
  'settings.restartUnavailable':
    '웹 UI에서의 다시 시작은 아직 지원되지 않습니다. 대기 중인 변경 사항을 적용하려면 게이트웨이 프로세스를 수동으로 다시 시작하세요.',
  ...
  'onboarding.subtitle':
    '시작하려면 AI 제공업체를 선택하세요. 나중에 설정에서 변경하거나 추가할 수 있습니다.',
  'onboarding.setUp': '설정',
  ...
  'onboarding.providerNearaiDesc':
    '무료 호스팅 모델에서 원하는 항목을 구성하세요. API 키 또는 SSO를 사용하세요.',
  ...
  'onboarding.nearaiLocalSso':
    '브라우저 기반 NEAR AI 로그인(GitHub, Google, NEAR 지갑)은 localhost에서 지원되지 않습니다. NEAR AI가 로컬 콜백 URL을 거부하기 때문입니다. 대신 NEAR AI API 키를 추가하거나 공개 URL에서 실행하세요.',
  ...
  'skills.noInstalledDesc':
    '스킬은 에이전트에 도메인별 지침을 추가합니다. ClawHub 레지스트리에서 설치하거나 워크스페이스에 SKILL.md 파일을 배치하세요.',
  ...
  'jobs.list.queueDesc':
    '제목 또는 ID로 검색하고 실행으로 이동해, 페이지를 떠나지 않고도 활성 작업을 중지할 수 있습니다.',
  ...
  'jobs.list.empty.noMatchDesc':
    '더 넓은 검색어를 사용하거나 상태 필터를 초기화해 큐의 나머지를 확인하세요.',
  'jobs.list.empty.noJobsTitle': '아직 작업이 없습니다',
  'jobs.list.empty.noJobsDesc':
    '게이트웨이가 작업을 만들기 시작하면 백그라운드 작업, 샌드박스 실행, 오퍼레이터 개입이 여기에 표시됩니다.',
  ...
  'automations.delivery.explainer':
    '트리거된 실행이 완료되면 자동화 결과가 전송되는 위치를 선택하세요.',
  ...
  'automations.delivery.webOptionDesc':
    '결과는 실행 기록에 저장됩니다. DM이나 알림은 전송되지 않습니다.',
  ...
  'automations.delivery.footnote':
    'DM으로 전송된 승인 요청은 Slack에서 {command}(으)로 답장하여 처리합니다.',
  ...
  'ext.registry.emptyDesc':
    '사용 가능한 확장이 이미 모두 설치되어 있거나, 레지스트리가 구성되어 있지 않습니다.',
  ...
  'projects.creationDraft':
    '새 프로젝트를 만들어줘. 다음을 위한 자율 워크스페이스를 설정하고 싶어: ',
  ...
  'extensions.emptyInstalledDesc':
    'WASM 도구, 채널 및 MCP 서버를 검색하고 설치하려면 레지스트리 탭을 탐색하세요.',
  'extensions.emptyMcpTitle': 'MCP 서버 없음',
  'extensions.emptyMcpDesc':
    'MCP 서버는 모델 컨텍스트 프로토콜을 통해 추가 도구 기능으로 에이전트를 확장합니다. 레지스트리에서 설치하십시오.',
  'common.dismiss': '닫기',
  'common.pin': '고정',
  'common.unpin': '고정 해제',
  'common.remove': '제거',
