...
registerPack('es', {
  ...
  'chat.suggestion1Desc':
    'Inspecciona el estado del runtime, canales, herramientas y trabajo abierto.',
  ...
  'authGate.resolveFailedAfterTokenSaved':
    'Token guardado. No se pudo reanudar la ejecución bloqueada; Vuelva a intentar reanudarlo.',
  ...
  'traceCommons.description':
    'Crédito obtenido por trazas redactadas contribuidas, limitado a tu cuenta.',
  'traceCommons.emptyState':
    'No inscrito — pide a tu agente que se inscriba con una invitación de Trace Commons.',
  ...
  'traceCommons.heldDescription':
    'Retenido por mayor riesgo de privacidad; revísalo y autorízalo para enviar.',
  ...
  'traceCommons.note':
    'Vista local a fecha de la última sincronización — el libro mayor de créditos autorizado está en el servidor. El crédito final puede cambiar tras la revisión de privacidad, replay/eval, comprobaciones de duplicados y la puntuación de utilidad posterior.',
  'settings.back': 'Atrás',
  ...
  'settings.restartUnavailable':
    'Reiniciar desde la interfaz web aún no está disponible. Reinicia el proceso del gateway manualmente para aplicar los cambios pendientes.',
  ...
  'onboarding.subtitle':
    'Elija un proveedor de IA para comenzar. Puedes cambiar o agregar más más adelante en Configuración.',
  ...
  'onboarding.providerOllamaDesc':
    'Ejecutar modelos abiertos localmente. No se necesita clave API.',
  'onboarding.nearaiWaiting': 'Esperando el inicio de sesión de NEAR AI en la pestaña abierta...',
  'onboarding.nearaiTimeout':
    'Se agotó el tiempo de espera para el inicio de sesión de NEAR AI. Por favor inténtalo de nuevo.',
  'onboarding.nearaiFailed': 'Error al iniciar sesión en NEAR AI. Por favor inténtalo de nuevo.',
  'onboarding.nearaiLocalSso':
    'El inicio de sesión en NEAR AI desde el navegador (GitHub, Google, monedero NEAR) no es compatible en localhost: NEAR AI rechaza las URL de retorno locales. Añade en su lugar una clave de API de NEAR AI, o ejecútalo tras una URL pública.',
  ...
  'onboarding.codexTimeout':
    'Se agotó el tiempo de espera para iniciar sesión en ChatGPT. Por favor inténtalo de nuevo.',
  ...
  'channels.slackAccessInstructions':
    'Elija los canales Slack en los que esta aplicación tenant puede responder.',
  ...
  'skills.importDesc':
    'Instalar desde una URL HTTPS SKILL.md o pegar el contenido de SKILL.md directamente.',
  'skills.name': 'Nombre de la habilidad',
  'skills.namePlaceholder': 'nombre de la habilidad',
  'skills.url': 'URL HTTPS',
  'skills.urlHint':
    'Utilice un enlace HTTPS directo a SKILL.md o un paquete de habilidades compatible.',
  'skills.urlPlaceholder': 'https://example.com/SKILL.md',
  'skills.content': 'Contenido de SKILL.md',
  'skills.contentHint':
    'Utilice esto en lugar de la URL al importar contenido de habilidades local o copiado.',
  ...
  'automations.delivery.explainer':
    'Elige dónde se entregan los resultados de la automatización cuando termina una ejecución activada.',
  ...
  'automations.delivery.webOptionDesc':
    'Los resultados se guardan en el historial de ejecuciones. No se envía ningún mensaje directo ni notificación.',
  'automations.delivery.unpairedNotice': 'Mensaje directo de Slack — no disponible',
  'automations.delivery.unpairedDesc':
    'Vincula tu cuenta de Slack para habilitar la entrega por mensaje directo.',
  ...
  'automations.delivery.footnote':
    'Las solicitudes de aprobación enviadas a tu mensaje directo se responden respondiendo {command} en Slack.',
  ...
  'pairing.slackInstructions':
    'Envíe un mensaje a la aplicación Slack, luego ingrese el código aquí.',
  ...
  'job.noActivityDesc':
    'Este trabajo no ha registrado eventos persistentes para el filtro seleccionado.',
  ...
  'extensions.emptyInstalledDesc':
    'Explore la pestaña Registro para descubrir e instalar herramientas, canales y servidores WASM.',
  'extensions.emptyMcpTitle': 'No hay servidores MCP',
  'extensions.emptyMcpDesc':
    'Los servidores MCP amplían el agente con capacidades de herramientas adicionales sobre el protocolo de contexto del modelo. Instálelos desde el registro.',
  ...
  'automations.detail.emptyDescription':
    'Elige una programación para revisar ejecuciones recientes.',
  ...
  'automations.summary.failuresDetail':
    'Automatizaciones con una ejecución fallida en el historial reciente.',
  ...
  'chat.heroMorning': '¿De qué quieres que se encargue IronClaw?',
  'chat.heroAfternoon': '¿De qué quieres que se encargue IronClaw?',
  'chat.heroEvening': '¿De qué quieres que se encargue IronClaw?',
  'chat.fileDownloadFailed': 'No se pudo descargar ese archivo',
