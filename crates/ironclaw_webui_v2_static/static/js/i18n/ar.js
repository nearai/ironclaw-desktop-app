...
registerPack('ar', {
  ...
  'login.heroSub':
    'يُبقي الوصول عبر الرمز (Token) وحدة تحكم المتصفح مرتبطة بنفس تشغيل البوابة والموافقات والأدوات وحالة الخيط.',
  ...
  'chat.emptyDesc':
    'أرسل رسالة أو أرفق ملفات أو اطلب فحص البوابة. تُظهر مساحة العمل الموافقات ونشاط التشغيل أثناء تقدم الدور.',
  ...
  'authGate.oauthWaiting':
    'في انتظار اكتمال التفويض... يمكنك إغلاق علامة التبويب المنبثقة بمجرد الموافقة على الوصول.',
  ...
  'authGate.resolveFailedAfterTokenSaved':
    'تم حفظ الرمز المميز. لا يمكن استئناف التشغيل المحظور؛ أعد محاولة استئنافه.',
  ...
  'traceCommons.note':
    'عرض محلي حتى آخر مزامنة — سجل الأرصدة المعتمد موجود على الخادم. قد يتغير الرصيد النهائي بعد مراجعة الخصوصية وإعادة التشغيل/التقييم وفحوصات التكرار وتقييم الفائدة اللاحق.',
  ...
  'settings.restartUnavailable':
    'إعادة التشغيل من واجهة الويب غير متاحة بعد. أعد تشغيل عملية البوابة يدويًا لتطبيق التغييرات المعلّقة.',
  ...
  'onboarding.subtitle':
    'اختر مزود الذكاء الاصطناعي للبدء. يمكنك تغيير أو إضافة المزيد لاحقًا في الإعدادات.',
  ...
  'onboarding.nearaiLocalSso':
    'تسجيل الدخول إلى NEAR AI عبر المتصفح (GitHub وGoogle ومحفظة NEAR) غير مدعوم على localhost — لأن NEAR AI يرفض عناوين الاستدعاء المحلية. أضف بدلاً من ذلك مفتاح API لـ NEAR AI، أو شغّله خلف عنوان URL عام.',
  ...
  'skills.noInstalledDesc':
    'توسّع المهارات الوكيل بتعليمات متخصصة. ثبّتها من سجل ClawHub أو ضع ملفات SKILL.md داخل مساحة العمل.',
  'skills.failedLoad': 'فشل تحميل المهارات: {message}',
  'skills.import': 'استيراد المهارات',
  'skills.importDesc':
    'التثبيت من عنوان URL الخاص بـ HTTPS SKILL.md أو لصق محتوى SKILL.md مباشرةً.',
  ...
  'skills.contentHint':
    'استخدم هذا بدلاً من عنوان URL عند استيراد محتوى المهارات المحلي أو المنسوخ.',
  ...
  'jobs.list.queueDesc':
    'ابحث بالعنوان أو المعرّف، ادخل إلى التنفيذ، وأوقف العمل النشط دون مغادرة الصفحة.',
  ...
  'jobs.list.empty.noMatchDesc':
    'جرّب عبارة بحث أوسع أو أعد ضبط عامل تصفية الحالة لرؤية بقية القائمة.',
  'jobs.list.empty.noJobsTitle': 'لا توجد مهام بعد',
  'jobs.list.empty.noJobsDesc':
    'ستظهر الأعمال في الخلفية وتشغيلات الـ sandbox وتدخلات المشغّل هنا عندما يبدأ الـ gateway بإنشاء المهام.',
  ...
  'automations.delivery.explainer':
    'اختر أين تُسلَّم نتائج الأتمتة عند انتهاء عملية تشغيل مُشغَّلة.',
  ...
  'automations.delivery.webOptionDesc':
    'تُحفَظ النتائج في سجل التشغيل. لا تُرسَل أي رسالة مباشرة أو إشعار.',
  'automations.delivery.unpairedNotice': 'رسالة Slack المباشرة — غير متاحة',
  'automations.delivery.unpairedDesc':
    'اربط حساب Slack الخاص بك لتمكين التسليم عبر الرسائل المباشرة.',
  ...
  'automations.delivery.footnote':
    'تتم الإجابة على طلبات الموافقة المُرسَلة إلى رسالتك المباشرة بالرد بـ {command} في Slack.',
  ...
  'projects.noDescription':
    'لا يوجد وصف للمشروع بعد. لا تزال مساحة العمل تتشكل عبر المهام النشطة وسجل المحادثات.',
  'projects.general.label': 'مساحة عمل عامة',
  'projects.general.title': 'غرفة تحكم المشروع الافتراضي',
  'projects.general.desc':
    'سياق مشترك، أعمال سريعة، ومسار تشغيل شامل للخيوط التي لم تُرقَّ بعد إلى مشروع مُسمّى.',
  'projects.scoped.title': 'مشاريع محددة النطاق',
  'projects.scoped.desc':
    'تصفح مساحات العمل الدائمة، افحص المهام، راجع النشاط الأخير، وانتقل إلى المشروع الذي يحتاجك الآن.',
  'projects.scoped.onlyGeneralTitle': 'مساحة العمل العامة فقط نشطة',
  'projects.scoped.onlyGeneralDesc':
    'أنشئ مشروعًا مُسمّى عندما يستحق العمل مهامه وملفاته وأدواته وسياقه الطويل الأمد.',
  'projects.empty.noMatchTitle': 'لا توجد مشاريع تطابق البحث الحالي',
  'projects.empty.noMatchDesc':
    'جرّب بحثًا أوسع أو امسح عامل التصفية للعودة إلى خريطة مساحة العمل الكاملة.',
  'projects.empty.noneTitle': 'لا توجد مشاريع بعد',
  'projects.empty.noneDesc':
    'تظهر المشاريع عندما ينشئ المساعد مساحات عمل دائمة. يمكنك البدء من الدردشة وطلب IronClaw لإنشاء مشروع محدد النطاق للعمل المستمر.',
  ...
  'extensions.emptyInstalledDesc':
    'تصفح علامة التبويب "التسجيل" لاكتشاف وتثبيت أدوات وقنوات WASM وخوادم MCP.',
  'extensions.emptyMcpTitle': 'لا توجد خوادم MCP',
  'extensions.emptyMcpDesc':
    'تعمل خوادم MCP على توسيع الوكيل بقدرات أداة إضافية عبر بروتوكول سياق النموذج. تثبيتها من التسجيل.',
