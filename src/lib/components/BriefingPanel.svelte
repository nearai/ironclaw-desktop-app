    ...
    >
      <header class="flex items-center gap-2 px-4 py-3 border-b border-border-subtle">
        ...
        <button
          ...
          title="Regenerate the brief with the current threads + open loops"
        >
      ...
      <section class="px-4 py-3 border-b border-border-subtle">
        ...
        {:else}
          <p class="text-[11px] text-text-muted mb-2">
            Nothing tracked yet. Add commitments and the brief will fold them into today's
            priorities.
          </p>
        {/if}
      ...
      <footer class="px-4 py-2 border-t border-border-subtle text-[11px] text-text-muted">
        Generated by your Chief of Staff from recent threads and open loops — nothing was sent into
        any conversation.
      </footer>
    </div>
  </div>
